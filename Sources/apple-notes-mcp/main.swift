...
// Launcher only. Everything testable lives in NotesMCPCore, which the test target
...
do {
    ...
    FileHandle.standardError.write(Data("apple-notes-mcp: \(error.localizedDescription)\n".utf8))
    exit(1)
}
