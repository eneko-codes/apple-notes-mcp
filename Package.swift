...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "NotesMCPCore",
            dependencies: ["NotesBridge", .product(name: "MCP", package: "swift-sdk")]
        ),
        .executableTarget(
            name: "apple-notes-mcp",
            dependencies: ["NotesMCPCore"],
        ...
        .testTarget(name: "NotesMCPCoreTests", dependencies: ["NotesMCPCore"]),
    ]
)
